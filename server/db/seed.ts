    ...
    const themes: MarketTheme[] = [
      {
        ...
        title: 'Jalur Pemotongan Suku Bunga Fed & Soft Landing',
        description: 'Pasar memperhitungkan beberapa pemotongan suku bunga Fed sebesar 25bps menyusul inflasi yang mereda dan data tenaga kerja yang stabil.',
        active_since: new Date(Date.now() - 14 * 86400000).toISOString(),
        primary_assets: ['USD', 'XAUUSD', 'US100', 'US500', 'US30'],
        sentiment: 'RISK_ON',
        evidence_events: ['CPI AS naik 3,1% YoY sesuai konsensus'],
      },
      {
        id: 'thm_gold_all_time_high',
        title: 'Akumulasi Emas Bank Sentral & Lindung Nilai Geopolitik',
        description: 'Permintaan bullion fisik yang konsisten dari pengelola cadangan global serta ekspektasi yield riil yang lebih rendah menjaga harga emas tetap tinggi.',
        active_since: new Date(Date.now() - 30 * 86400000).toISOString(),
        primary_assets: ['XAUUSD', 'USD', 'BTC'],
        sentiment: 'BULLISH',
        evidence_events: ['Cadangan emas global mencapai alokasi rekor'],
      },
      {
        id: 'thm_tech_capex_momentum',
        title: 'Belanja Infrastruktur AI Perusahaan',
        description: 'Hyperscaler bermodal besar mempertahankan belanja modal semikonduktor dan komputasi awan, menopang ketahanan US100.',
        active_since: new Date(Date.now() - 45 * 86400000).toISOString(),
        primary_assets: ['US100', 'US500', 'BTC'],
        sentiment: 'BULLISH',
        evidence_events: ['Pesanan foundry semikonduktor melampaui estimasi'],
      },
    ];
