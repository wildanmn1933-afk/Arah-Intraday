...
const TRACKED_SYMBOLS: SymbolConfig[] = [
  ...
  },
  {
    ...
    ySymbol: 'GC=F',
    tvSymbol: 'TVC:GOLD',
    displayName: 'Emas / Dolar AS (Spot/Futures)',
    assetType: 'COMMODITY',
    sourceName: 'TVC:GOLD (Feed Real-Time)',
  },
  {
    symbol: 'US30',
    ySymbol: 'YM=F',
    tvSymbol: 'FOREXCOM:US30',
    displayName: 'Indeks Dow Jones 30 (Wall St 30)',
    assetType: 'INDEX',
    sourceName: 'FOREXCOM:US30 (CFD Real-Time)',
  ...
  },
  {
    ...
    displayName: 'Indeks S&P 500 (US 500)',
    assetType: 'INDEX',
    sourceName: 'CAPITALCOM:SPX500 (CFD Real-Time)',
  ...
  },
  {
    ...
    displayName: 'Indeks Nasdaq 100 (US Tech 100)',
    assetType: 'INDEX',
    sourceName: 'SKILLING:US100 (CFD Real-Time)',
  ...
  },
  {
    ...
    ySymbol: '^TNX',
    tvSymbol: 'TVC:US10Y',
    displayName: 'Yield Treasury AS 10 Tahun',
    assetType: 'BOND',
    sourceName: 'TVC:US10Y (Benchmark Yield 10Y)',
  ...
  },
  {
    ...
    ySymbol: 'DX-Y.NYB',
    tvSymbol: 'TVC:DXY',
    displayName: 'Indeks Dolar AS (DXY)',
    assetType: 'FOREX',
  ...
  },
  {
    ...
    ySymbol: 'EURUSD=X',
    tvSymbol: 'FX:EURUSD',
    displayName: 'Euro / Dolar AS (EURUSD)',
    assetType: 'FOREX',
  ...
  },
  {
    ...
    ySymbol: 'GBPUSD=X',
    tvSymbol: 'FX:GBPUSD',
    displayName: 'Pound Inggris / Dolar AS (GBPUSD)',
    assetType: 'FOREX',
  ...
  },
  {
    ...
    ySymbol: 'USDJPY=X',
    tvSymbol: 'FX:USDJPY',
    displayName: 'Dolar AS / Yen Jepang (USDJPY)',
    assetType: 'FOREX',
  ...
  },
  {
    ...
    ySymbol: 'AUDUSD=X',
    tvSymbol: 'FX:AUDUSD',
    displayName: 'Dolar Australia / Dolar AS (AUDUSD)',
    assetType: 'FOREX',
  ...
  },
  {
    ...
    ySymbol: 'NZDUSD=X',
    tvSymbol: 'FX:NZDUSD',
    displayName: 'Dolar Selandia Baru / Dolar AS (NZDUSD)',
    assetType: 'FOREX',
  ...
  },
  {
    ...
    ySymbol: 'USDCAD=X',
    tvSymbol: 'FX:USDCAD',
    displayName: 'Dolar AS / Dolar Kanada (USDCAD)',
    assetType: 'FOREX',
  ...
  },
  {
    ...
    ySymbol: 'USDCHF=X',
    tvSymbol: 'FX:USDCHF',
    displayName: 'Dolar AS / Franc Swiss (USDCHF)',
    assetType: 'FOREX',
      ...
      if (res.ok) {
        ...
        if (!isNaN(price) && price > 0) {
          return {
            ...
            source: 'Feed Binance Live 24 Jam',
            status: 'LIVE',
          };
        }
      }
