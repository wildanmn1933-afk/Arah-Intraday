...
export const MARKET_GLOSSARY: Record<string, GlossaryItem> = {
  ...
  UTC: {
    term: 'Waktu Universal Terkoordinasi (UTC)',
    shortLabel: 'UTC',
    category: 'TIMING',
  ...
  ACTUAL: {
    term: 'Nilai Aktual (Rilis Aktual)',
    shortLabel: 'ACTUAL',
    category: 'MACRO',
  ...
  SURPRISE: {
    term: 'Kejutan Makro (Deviasi Kejutan)',
    shortLabel: 'SURPRISE',
    category: 'MACRO',
  ...
  OVERALL_BIAS: {
    term: 'Bias Pasar Intraday (Arah Kecenderungan)',
    shortLabel: 'BIAS',
  ...
  CONFIDENCE: {
    term: 'Skor Keyakinan (Tingkat Keyakinan Algoritmik)',
    shortLabel: 'CONF',
    category: 'INTELLIGENCE',
  ...
  CHANGE_24H: {
    term: 'Perubahan Persentase 24 Jam',
    shortLabel: 'CHG 24J',
  ...
  RANGE_24H: {
    term: 'Rentang Harga 24 Jam (High / Low)',
    shortLabel: 'RANGE 24J',
    category: 'PRICE_ACTION',
  ...
  SPREAD: {
    term: 'Spread Bid-Ask (Spread Likuiditas)',
    shortLabel: 'SPREAD',
    category: 'EXECUTION',
  ...
  ADR: {
    term: 'Average Daily Range (Penggunaan ADR)',
    shortLabel: 'ADR',
    category: 'PRICE_ACTION',
  ...
  REACTION_HORIZONS: {
    term: 'Horizon Reaksi (R1M, R5M, R15M, R1H, R4H)',
    shortLabel: 'REACTION',
    category: 'MACRO',
  ...
  PRIMARY_ASSET: {
    term: 'Aset Benchmark Utama (Aset Acuan)',
  ...
  FUNDAMENTAL_IMPLICATION: {
    term: 'Implikasi Fundamental (Implikasi Makro)',
  ...
  ACTUAL_MARKET_REACTION: {
    term: 'Reaksi Pasar Aktual (Reaksi Riil Likuiditas)',
  ...
  DIVERGENCE_DELTA: {
    term: 'Delta Divergensi (Diferensial Kekuatan)',
    shortLabel: 'DELTA',
    category: 'CURRENCY',
  ...
  CHOP_AVOID: {
    term: 'Tier Hindari Chop / Whipsaw',
    shortLabel: 'CHOP',
    category: 'EXECUTION',
  ...
  SSE_STATUS: {
    term: 'Status Feed Live Server-Sent Events (SSE)',
    shortLabel: 'SSE',
    category: 'EXECUTION',
  ...
  FRESHNESS: {
    term: 'Kesegaran & Provenance Data (Kesegaran Data)',
