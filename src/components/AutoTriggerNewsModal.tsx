        ...
        <div className="p-5 overflow-y-auto space-y-5 text-xs text-slate-300">
          ...
          <div className="p-4 rounded-lg bg-slate-950/90 border border-slate-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg font-bold text-xs tracking-wide transition cursor-pointer shrink-0 ${
                config.enabled
            ...
            <div className="p-3 rounded-lg bg-slate-950/60 border border-slate-800/80 space-y-1.5 flex flex-col justify-between">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  onUpdateConfig({ soundEnabled: newVal });
                  soundManager.setMuted(!newVal);
                  if (newVal) soundManager.playBreakingNewsChime();
                }}
                className={`w-full py-1.5 px-2 rounded text-[11px] font-bold border transition cursor-pointer flex items-center justify-center gap-1.5 ${
                  config.soundEnabled
