...
export const EventCard: React.FC<EventCardProps> = ({ event, onClick, isSelected }) => {
  ...
  return (
    <div
      onClick={onClick}
      className={`p-4 rounded-xl border transition-all duration-150 cursor-pointer overflow-hidden ${
        isSelected
          ? 'bg-slate-900/95 border-cyan-500/80 shadow-lg shadow-cyan-950/40 ring-1 ring-cyan-500/30'
          : 'bg-slate-900/70 hover:bg-slate-900/95 border-slate-800/80 hover:border-slate-700/80 shadow-xs'
      }`}
    >
