        ...
        {filteredPrices.map(item => {
          ...
          return (
            <div
              ...
              className="p-3 rounded-lg bg-slate-900/60 hover:bg-slate-900 border border-slate-800/80 hover:border-slate-700 transition cursor-pointer flex flex-col justify-between group space-y-2.5 min-w-0 overflow-hidden"
            >
                ...
                <div className="flex items-center justify-between text-slate-500 text-[9px] gap-1">
                  ...
                  <div className="flex items-center gap-1.5 shrink-0 whitespace-nowrap">
                    ...
                    <MetricTooltip term="SSE_STATUS" underline={false}>
                      <span className={`font-bold px-1 py-0.2 rounded text-[8px] border cursor-help whitespace-nowrap ${
                        item.status === 'LIVE'
