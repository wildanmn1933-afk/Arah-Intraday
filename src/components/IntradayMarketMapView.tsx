            ...
            return (
              <motion.div
                ...
                animate={
                  isPulsingUp
                    ? {
                        borderColor: ['rgba(16, 185, 129, 0.75)', 'rgba(16, 185, 129, 0.35)', 'rgba(30, 41, 59, 1)'],
                        backgroundColor: ['rgba(6, 78, 59, 0.25)', 'rgba(6, 78, 59, 0.08)', 'rgba(15, 23, 42, 0.9)'],
                        scale: [1, 1.012, 1],
                      }
                    : isPulsingDown
                    ? {
                        borderColor: ['rgba(244, 63, 94, 0.75)', 'rgba(244, 63, 94, 0.35)', 'rgba(30, 41, 59, 1)'],
                        backgroundColor: ['rgba(136, 19, 55, 0.25)', 'rgba(136, 19, 55, 0.08)', 'rgba(15, 23, 42, 0.9)'],
                        scale: [1, 1.012, 1],
                      }
                    : {
                ...
                className="relative border rounded-lg p-4 transition-colors flex flex-col justify-between space-y-3.5 shadow-sm overflow-hidden"
              >
